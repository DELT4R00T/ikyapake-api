...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO IKY REST API!') // boleh diubah
}

var creatorList = ['Iky Apake']; // Nama Lu Ngab
var creator = creatorList[Math.floor(Math.random() * creatorList.length)]; // Ini jan diubah
var key = 'IkyDev' // Apikey Lu Ngab
...
loghandler = {
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: `Apikey tidak ditemukan! Silahkan kontak Owner untuk dapatkan Apikey wa.me/6285211527292`
    },
    invalidLink: {
        status: false,
        creator: `${creator}`,
